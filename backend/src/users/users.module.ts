...
@Module({
  ...
  providers: [GetUserByIdHandler, ListUsersHandler, CreateUserHandler, FindUsersHandler],
  exports: [GetUserByIdHandler, ListUsersHandler, CreateUserHandler, FindUsersHandler],
})
